...
## Project Structure
    ...
    ├── testapiautodatamod_123690  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_123690`
...
2. Clone this repo and `cd testapiautodatamod_123690`
